...
print("La temperatura ingresada en Celsius es: ", celsius , "La misma equivale a ", fahrenheit , "grados fahrenheit")
...
print(f"El nombre de usuario es: {nombre_usuario} y el tipo de dato es: {type(nombre_usuario)}")
print(f"La edad del usuario es: {edad_usuario} y el tipo de dato es: {type(edad_usuario)} ")
print(f"La ciudad de residencia es: {ciudad_usuario} y el tipo de dato es : {type(ciudad_usuario)}")
