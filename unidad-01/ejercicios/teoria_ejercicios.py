...
Debe contemplar:
1) Exactitud: Debe indicar un orden claro de ejecución sin ambiguedades.
2) Definición: Ejecutando el mismo algoritmo con  la misma entrada, debe producir la misma salida.
...
""""
Tipos de lenguaje:
1) Bajo Nivel: Dependen de una maquina específica. Controlan directamente el hardware. (Lenguaje ensamblador)
2) Alto Nivel: Independientes de la máquina. Permiten crear y gestionar aplicaciones de formas más sencillas. Ej: Python.
"""
...
"""
Compilado: Traduce todo el código fuente a lenguaje máquina en un solo proceso
